...
> What is the purpose of the LD_PRELOAD variable?
> 
> 
...
**Prerequisites to abuse the LD_PRELOAD variable:**
...
- To abuse ld_preload, you need to write a C code containing the `same signature of a function used by the program`
- This means that:
